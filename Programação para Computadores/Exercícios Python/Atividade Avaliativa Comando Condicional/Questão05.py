# Solicitar os valores de dia, mês e ano ao usuário
...
# Definir os dias de cada mês, considerando se o ano é bissexto
if bissexto:
...
# Verificar se o dia é válido para o mês informado
elif dia < 1 or dia > dias_por_mes[mes - 1]:
    print(f"Erro: o mês {mes} não tem {dia} dias.")
else:
    # Calcular o dia juliano manualmente
